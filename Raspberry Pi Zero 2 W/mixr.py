...
def convert_image(path):
    ...
    try:
        ...
        # DIE SCHNELLE METHODE (Bleibt drin!)
        pixels = list(img.getdata())
        # Blau (b) nach vorne, Rot (r) nach hinten
...
def main():
    ...
    print("🎛️ Mixr Classic Speed (Fast Convert).")
    prev = [-1] * NUM_SLIDERS
    last = 0
